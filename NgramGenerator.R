...
saveRDS(ngram5, file= "~/data1/CAPstone/ngram5.rds")
saveRDS(ngram4, file= "~/data1/CAPstone/ngram4.rds")
saveRDS(ngram3, file= "~/data1/CAPstone/ngram3.rds")
saveRDS(ngram2, file= "~/data1/CAPstone/ngram2.rds")
saveRDS(ngram1, file= "~/data1/CAPstone/ngram1.rds")
